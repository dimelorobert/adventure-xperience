...
PRIMARY KEY(id)
    ...
    await connection.query(`
    INSERT INTO adventure(name, description, image, price, city, vacancy, date_select) VALUES('Paracaidismo', 'Excursion Paracaidas en grupo', 'https://img.com/img.jpg',50.95, 'Valencia', 5, '${formatDateToDB(
      new Date()
    )}');
  `);
