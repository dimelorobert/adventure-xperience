...
CREATE DATABASE IF NOT EXISTS goldi_pets_db;
/* Usar base de datos*/
USE adventure_db;
SELECT * FROM users; 
DESCRIBE users;

UPDATE users SET is_account_active=1 WHERE email='airbusjayrobert+user87@gmail.com';
UPDATE users SET is_admin=0 WHERE email='airbusjayrobert+user87@gmail.com';
